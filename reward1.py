...
def score_steer_to_pt_ahead(params):
    ...
    error = (steering_angle - best_steering_angle) / 50.0
    score = 1.0 - abs(error)
...
def reward_function(params):
    ...
    # High reward for staying on track
    if params['all_wheels_on_track']:
        reward += 11.5

    # Check direction
    reward = check_direction(params['waypoints'], params['closest_waypoints'], params['heading'], reward)
